...
public class Board_HW extends JPanel {
    ...
    public Board_HW() {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                // You can update the board state when clicked here
                // For now, just storing the x and y
                lastMoveX = x;
                lastMoveY = y;
                repaint();
            }
