...
public class AIPlayer implements Player{
    ...
    public AIPlayer(Stone stoneType, Stone[][] currentBoard, PrintStream outputStream) {
    ...
    public int[] bestMove() {
        ...
        setLastMove(move);
        board.updateLastMove(move[0], move[1]);
        outputStream.println("\u001B[31m"+"Last Move made: [" + board.getLastMoveX() + "] [" + board.getLastMoveY() + "]" + "\u001B[0m");
        return move;
    }
